  ...
  return (
    ...
    <section className='flex flex-row items-center justify-center selection:bg-slate-500 selection:text-slate-200'>
      <div className='mx-10 container flex flex-col'>
        ...
        <div className="pt-6 font-['Work_Sans'] text-3xl font-bold text-slate-700 grid grid-cols-4">
          <div className='flex flex-col items-center'>
            <img className="hue-rotate-220" src={skillIcons.html5} alt="html5_icon"></img>
            <h2 >HTML5</h2>
          </div>
        </div>
      </div>
